    ...
    const events: Event[] = [
      {
        ...
        description: "Une soirée dans mon magnifique jardin avec potluck et musique live!",
        date: "2024-07-15",
        time: "18:00",
      ...
      },
      {
        ...
        description: "Venez découvrir mon petit coin de paradis avec barbecue géant!",
        date: "2024-07-22",
        time: "19:00",
        location: "456 Avenue des Roses, Lyon",
...
export default function EventsPage({ data: events }: PageProps<Event[]>) {
  return (
                    ...
                    <div class="flex-1">
                      ...
                      <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        ...
                        <div>
                          ...
                          <p class="text-gray-600">
                            👥 {event.rsvp_count}{event.max_attendees ? `/${event.max_attendees}` : ''} participants
                          </p>
                        </div>
                      </div>
                    </div>
        ...
        <section class="mt-12 text-center">
          <div class="bg-green-100 rounded-lg p-8">
            ...
            <p class="text-green-700 mb-6">
              Partagez votre jardin avec la communauté et créez des moments inoubliables
            </p>
            <a 
              href="/host"
